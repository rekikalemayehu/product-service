...
class ProductControllerTest {
    ...
    void create_returns201_withLocation() throws Exception {
        String body = "{\"name\":\"Headphones\",\"price\":89.99,\"stockQty\":50,\"category\":\"Audio\"}";
    ...
    void update_returns200() throws Exception {
        String body = "{\"name\":\"Pro Laptop\",\"price\":1299.0,\"stockQty\":5,\"category\":\"Electronics\"}";
    ...
    void create_returns400_whenNameBlank() throws Exception {
        String invalid = "{\"name\":\"\",\"price\":10.0,\"stockQty\":1,\"category\":\"Tech\"}";
        mockMvc.perform(post("/api/v1/products")
                .contentType(MediaType.APPLICATION_JSON)
                .content(invalid))
